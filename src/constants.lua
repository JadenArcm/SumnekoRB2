...
--
-- * In SRB2 v2.2.13, `54` is the default value for this constant.
MODVERSION = 54
...
--
-- * Pressing jump a second time in mid-air will make the player start a glide; the player will accelerate forward from a starting speed determined by `actionspd` for as long as the jump button is held down; however, the player will gradually lose height while doing so.
